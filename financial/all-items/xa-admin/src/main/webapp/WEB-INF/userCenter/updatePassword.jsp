...
<body>
	...
	<div id="p" class="easyui-panel" title="修改密码" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/user/updatePass.htm">
			<div style="margin-bottom:20px">
			  <input type="hidden" name="id" value="${user.id }" />
			</div>
			
			<div style="margin-bottom:20px">
			  <input class="easyui-passwordbox" name="password" style="width:60%" value="" data-options="label:'新密码:',required:true">
			</div>
			
			<div style="margin-bottom:20px">
			  <input class="easyui-passwordbox" name="repeatPass" style="width:60%" value="" data-options="label:'重复新密码:',required:true">
			</div>
