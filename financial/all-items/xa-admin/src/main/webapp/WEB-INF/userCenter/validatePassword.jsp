...
<body>
	...
	<div id="p" class="easyui-panel" title="验证密码" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
	 <span style="color:rgb(255,0,0)">${msg }</span>
		...
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/user/validatePassword.htm">
			<div style="margin-bottom:20px">
			  <input type="hidden" name="id" value="${user.id }" />
			  <input class="easyui-passwordbox" name="password" style="width:60%" value="" data-options="label:'原密码:',required:true">
			</div>
