...
<body>
	...
	<div id="p" class="easyui-panel" title="添加品牌" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/brand/addBrand.htm">
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="name" style="width:60%" data-options="label:'品牌名称:',required:true">
				<%--
			...
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="info" style="width:100%;height:60px" data-options="label:'品牌描述:',multiline:true">
			</div>
			...
			<div style="margin-bottom:20px">
				...
				<div id="p" class="easyui-panel" title="品牌详情图" style="width:60%;height:auto;padding:10px;">
				      <div>
				     	<img id="imgBrandDetail" src="" width="60%" height="auto" style="display: block;" /> 
				      </div>
				</div>
			</div>
