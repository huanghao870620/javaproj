...
<body>
	...
	<table id="dg" title="角色列表" style="width:100%;height:auto"
			data-options="rownumbers:true,singleSelect:true,pagination:true,url:'listRole.htm',method:'get'">
		<thead>
			<tr>
				<th data-options="field:'id',width:200">ID</th>
				<th data-options="field:'name',width:200">角色名称</th>
				<%--
				<th data-options="field:'email',width:400">邮箱</th>
