...
<body>
	...
	<div id="p" class="easyui-panel" title="添加角色" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/role/addRole.htm">
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="name	" style="width:40%" data-options="label:'角色名称:',required:true">
			</div>
			...
			<%--
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="info" style="width:100%;height:60px" data-options="label:'角色描述:',multiline:true,required:true">
			</div>
			...
			<div style="margin-bottom:20px">
				...
				<div id="p" class="easyui-panel" title="用户头像" style="width:60%;height:auto;padding:10px;">
				      <div>
