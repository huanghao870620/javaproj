	...
	$(function(){
		var pager = $('#dg').datagrid({
			onDblClickRow: function(rowIndex,rowData){
				 window.location.href = "<%=request.getContextPath()%>/coupons/toEditCoupons.htm?id=" + rowData.id;
			},
			 toolbar:[
...
<body>
	...
	<table id="dg" title="优惠券列表" style="width:100%;height:auto"
			data-options="rownumbers:true,singleSelect:true,pagination:true,url:'listCoupons.htm',method:'get'">
		<thead>
			<tr>
				<th data-options="field:'id',width:50">ID</th>
				<th data-options="field:'name',width:200">名称</th>
				<th data-options="field:'allocTypeName',width:200">分配类型</th>
				<th data-options="field:'price',width:100">金额</th>
				 <th data-options="field:'sill',width:100">门槛</th> 
				 <th data-options="field:'lStart',width:200">开始时间</th>
				 <th data-options="field:'lEnd',width:200">结束时间</th>
