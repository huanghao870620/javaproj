...
<body>
	...
	<table id="dg" title="活动列表" style="width:100%;height:auto"
			data-options="rownumbers:true,singleSelect:true,pagination:true,url:'listActivity.htm',method:'get'">
		<thead>
			<tr>
			<th data-options="field:'id',width:200">ID</th>
				<th data-options="field:'name',width:200">活动名称</th>
				 <th data-options="field:'info',width:400">活动描述</th> 
			</tr>
		</thead>
	</table>
</body>
