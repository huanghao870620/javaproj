...
<body>
	...
	<div id="p" class="easyui-panel" title="添加颜色" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/color/addColor.htm">
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="name" style="width:60%" data-options="label:'颜色名称:',required:true">
			</div>
			<%--
			<div style="margin-bottom:20px">
