...
<body>
	...
	<div id="p" class="easyui-panel" title="编辑国家" style="width:100%;height:auto;padding:10px;">
	...
	<div class="easyui-panel" title="" style="width:100%;max-width:700px;padding:30px 60px;">
		<form id="ff" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/country/editCountry.htm">
			<div style="margin-bottom:20px">
			   <input type="hidden" name="id" value="${country.id }">
				<input class="easyui-textbox" name="name" value="${country.name }"  style="width:60%" data-options="label:'国家名称:',required:true">
			</div>
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="countryCode" value="${country.countryCode }" style="width:40%" data-options="label:'国家代码:',required:true">
			</div>
