...
<body>
	...
	<table id="dg" title="容量类型列表" style="width:100%;height:auto"
			data-options="rownumbers:true,singleSelect:true,pagination:true,url:'listCapacityType.htm',method:'get'">
		<thead>
			<tr>
				<th data-options="field:'id',width:200">ID</th>
				<th data-options="field:'name',width:200">类型</th>
				<th data-options="field:'unit',width:400">单位</th>
			</tr>
		</thead>
	</table>
