...
public class RealNameAuthServiceImpl extends BaseServiceImpl<RealNameAuth, RealNameAuthMapper>
	...
	public String addRealNameAuth(RealNameAuth realNameAuth,
		...
		goodsService.uploadFile(request, frontCartPhotoFile, PhotoType.CERTIFICATION_FRONT_PHOTO,frontFile); //身份证正面照
		
		com.xa.entity.File backFile = new com.xa.entity.File();
		goodsService.uploadFile(request, backCartPhotoFile, PhotoType.CERTIFICATION_BACK_PHOTO,backFile); //身份证正面照
