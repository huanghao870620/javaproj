...
<%@ taglib uri="/breadCrub" prefix="cc" %>
...
<link href="<%=request.getContextPath() %>/res/back/css/customer.css" type="text/css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/res/back/css/jquery.treeview.css" />
...
<script type="text/javascript" src="<%=request.getContextPath() %>/res/js/back/jquery.cookie.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/res/js/back/jquery.treeview.js"></script>
