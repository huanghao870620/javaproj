...
<link href="<%=contextPath %>/res/back/css/lecturer-internal_type.css" type="text/css" rel="stylesheet" />
...
<%@include file="/jsp/back/menu/menu.jsp"%>
    <div class="contain_main">
        ...
        <div class="course">
            <a class="cour01" href="<%= contextPath %>/back/internal/toInternalListPage.htm?internalType=1"></a>
            <a class="cour02" href="<%= contextPath %>/back/internal/toInternalListPage.htm?internalType=2"></a>
        </div>
    </div>
</div>
</body>
