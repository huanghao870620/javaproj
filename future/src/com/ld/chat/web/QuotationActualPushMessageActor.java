 ...
 */
public class QuotationActualPushMessageActor extends BaseActor implements Runnable {
	
	private UserDtoSessionBinding binding;
	private WeiboMessage message;
	
	public QuotationActualPushMessageActor(UserDtoSessionBinding binding, WeiboMessage message){
